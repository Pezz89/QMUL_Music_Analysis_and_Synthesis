...
\begin{figure}[H]
    ...
    length = 14)}
    \makebox[\textwidth]{\includegraphics[width=1.2\textwidth]{Guitar14RawFeatures}}
    \label{Guitar14RawFeatures}
\end{figure}
\begin{figure}[H]
    \caption{Standard deviation of features and segment selection (minimum period
    length = 14)}
    \makebox[\textwidth]{\includegraphics[width=1.2\textwidth]{Guitar14StdDevSeg}}
    \label{Guitar14StdDevSeg}
\end{figure}
\begin{figure}[H]
    \caption{Zero-crossing segmentation of audio (Minimum period length = 3)}
    \makebox[\textwidth]{\includegraphics[width=1.2\textwidth]{ZeroX}}
    \label{ZeroX}
\end{figure}
